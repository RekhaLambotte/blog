<?php
    if(isset($_GET["deconnect"]) && ($_GET["deconnect"])== true){
        ...
        session_destroy(); // supprime la session mais ne sera actif lors du chargement de la prochaine page
        header("location: ./index.php"); // donc on recharge sur la page home
        exit();
    }
?>
    ...
    <nav>
        ...
        ?>
            <ul>
                ...
                <li><a href="../../index.php?deconnect=true"><i class="fas fa-user-alt-slash"></i>Se Déconnecter</a></li>
        ...
        ?>
               <li><a href="../../src/pages/rediger.php"><i class="fas fa-user"></i>rédiger</a></li> 
        <?php
            }
